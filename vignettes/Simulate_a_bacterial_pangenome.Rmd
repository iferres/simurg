...
(package) provides a single function , `simpg()`, and some methods associated to the output class. To access the documentation, run:
```{r help, eval=FALSE}
?simpg
# or
help('simpg')
...
pg <- simpg(ref = ref, # Reference multi-fasta file
            norg = 10, # Number of organisms to sample
...
# Coalescent times
brln <- spg$Branching_length
plot(brln); abline(0, 1)
